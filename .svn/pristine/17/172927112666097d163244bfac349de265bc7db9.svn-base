<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		<nav class="navbar sticky-top transparent" id="navbar-top">
			<!-- side navi bar btn -->
			<div class="col-1">
				<button id="sidebarCollapse" class="navbar-toggler text-dark"
			...
			<div class="col-3 text-left">
				<a class="navbar-brand font-weight-bolder" href="#"> <span
					class="h2 font-weight-bolder">공공연한사이</span>
				</a>
			</div>
			<!-- brand name, title -->
			<!-- search bar -->
			...
			<ul class="nav flex-column m-3">
				<li class="nav-item dropdown">
					<ul class="list-unstyled components mb-5">
						...
						<li><a href="#" class="h4">고객문의센터</a></li>
					</ul>
				</li>
			</ul>
		</nav>
