			...
			<div class="row">
				...
				<div class="col-8 mt-4">
					<div class="container">
						...
						<h2 class="mt-3 font-weight-bold">최근 예매내역</h2>
						<div class="card mt-3">
							<div class="card-body">
								<div class="row">
									<div class="col-3">
										...
										<div class="row">
											<div class="col-12">
												<div class="row">
													...
													<div class="col-2 mt-1 offest-2 text-right">
														<span>더보기</span>
						...
						<h2 class="mt-3 font-weight-bold">나의 관심 공연</h2>
						<div class="card mt-3">
							<div class="card-body">
								<div class="row">
									<div class="col-12">
										<div class="row">
											<div class="col-12">
												<div class="offset-9 col-2 text-right mt-1 mb-2">
						...
						<h2 class="mt-3 font-weight-bold">나의 문의 내역</h2>
						<div class="card mt-3">
							<div class="card-body">
								<div class="row">
									<div class="col-3">
