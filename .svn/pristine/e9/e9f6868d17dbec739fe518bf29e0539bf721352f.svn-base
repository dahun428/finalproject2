		...
		<div class="container-fluid">
					...
					<form method="get" id="search-form">
						...
						<div class="form-group">
							...
							<div class="btn-group-toggle  " >
								...
								<label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="action">액션
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="crime">범죄
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="thriller">스릴러
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="romance">로맨스
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="sf">SF
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="fantasy">판타지
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="adventure">모험
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="family">가족
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="animation">애니메이션
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="drama">드라마
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="musical">뮤지컬
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="checkbox" name="genre" value="documentory">다큐멘터리
								</label>
							</div>
						...
						<div class="form-group">
							...
							<div class="btn-group-toggle  " data-toggle="buttons">
								<label class="btn btn-outline-danger mb-2"> <input
									type="radio" name="age" value="all" checked="checked">전체
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="radio" name="age" value="12">12세이상
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="radio" name="age" value="15">15세이상
								</label> <label class="btn btn-outline-danger mb-2"> <input
									type="radio" name="age" value="adult">청소년관람불가
								</label>
							</div>
						</div>					
			...
			<div class="row mt-5 justify-content-center">
				...
				<div class="col-8 mt-3">
					...
					<div class="row">
						<!--  				
						<div class="col-1 bg-dark text-center justify-content-center">
							<div>							
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-9">
											<div class="row mb-2">
												<div class="col-12">
													<span class="badge badge-pill badge-warning mr-2">15</span>
													<h5 class="d-inline font-weight-bold">다만 악에서 구원하소서</h5>
												</div>
											</div>
											<div class="row mb-2">
												<div class="col-7 ">
										...
										<div class="col-12 d-flex justify-content-between">
											<div>
												...
												<div class="d-inline mr-2">
													<i class='fas fa-heart mr-2'
														style='font-size: 24px; color: red;'></i><label>52</label>
												</div>
												<div class="d-inline">
											...
											<div>
												<button type="button" class="btn btn-outline-danger mr-2"
													onclick="buyTicket(1)">예매하기</button>
												<button type="button" class="btn btn-outline-dark"
													onclick="showDetail(1)">상세보기</button>
											</div>
										</div>
									</div>
									<!--  
								...
								<div class="card-body">
									...
									-->
										...
										<button type="button" class="btn btn-outline-dark btn-lg"
											onclick="showMateGroup(1)">메이트 그룹</button>
									</div>
									<!-- 태그 창 끝 -->
								</div>
								<!-- card body 끝 -->
								...
								<div class="mt-3 p-2">
									...
									<table class="table table-bordered mt-3">
										...
										<tbody>
											...
											<tr>
												<th>공연기간(개봉일)</th>
												<td>2020년 8월 30일(일) ~ 2020년 11월 15일(일)</td>
											</tr>
											<tr>
												<th>공연시간</th>
												<td>화, 목, 금 8시 | 수 4시, 8시 | 토, 일, 공휴일 2시, 6시 |
