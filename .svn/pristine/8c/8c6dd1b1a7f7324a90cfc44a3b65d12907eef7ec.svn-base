...
<div class="container " style="margin-top: 150px;">
	<div class="row ">
		<div class="col-8 mx-auto" >
			<form name="form" method="GET" id="sns-signup-form" action="snsSignup.do">
				<div class="card border-0">
					<div class="card-header bg-white text-black font-weight-bolder"><h4>SNS간편 회원가입</h4></div>
					<div class="card-body">
						<div class="form-row">
							<div class="form-group col-md-9">
      							<input type="text" class="form-control" id="" name="userId"  placeholder="아이디를 입력하세요 (5~20자의 영문 소문자만 사용 가능합니다.)">
							</div>
						...
						<div class="form-row mt-3">
							<div class="form-group col-md-9">
      							<input type="text" class="form-control" id="" name="name" placeholder="닉네임을 입력하세요 (한 글자 이상의 한글을 사용하세요.)">
							</div>
							<div class="form-group col-md-2">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
      							<input type="text" class="form-control" id="" name="password1" placeholder="비밀번호를 입력하세요 (8~16자 영문 대 소문자, 숫자, 특수문자를 사용하세요.)">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
      							<input type="text" class="form-control" id="" name="password2" placeholder="비밀번호를 다시 입력하세요">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
