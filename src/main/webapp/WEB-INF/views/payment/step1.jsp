															...
															<div class="row text-left" style="height: 70%">
																<div class="col-6">
																	<div class="card">
																		...
																		<div class="card-body">
																			<div>n회<a href="">12시 20분</a></div>
																			<div>n회<a href="">18시 00분</a></div>
																			<div>n회<a href="">18시 00분</a></div>
																		</div>
																	</div>
																</div>
									...
									<table class="table-bordered" style="margin-bottom: 10px;">
										<tbody>
											<tr>
												...
												src="/resources/sample-images/sample1.jpg"
					...
					$('#fullpage').fullpage(
							{
								...
								afterSlideLoad: function(section, origin, destination, direction) {
											...
											var performInfo = '<tr>';
												...
												performInfo += '<td>2020.08.21</td>'
												performInfo += '</tr>'
												performInfo += '<tr>'
												performInfo += '<th class="text-center">시간</th>'
												performInfo += '<td>[1회] 20시 30분</td>'
												performInfo += '</tr>'
												performInfo += '<tr>'
